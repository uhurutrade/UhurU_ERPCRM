        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-8 relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            ...
            <div className="relative z-10 max-w-6xl w-full">
                ...
                <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom duration-700" style={{ animationDelay: '200ms' }}>
                    ...
                    {/* Hero Action */}
                    <div className="mb-12 flex justify-center animate-in fade-in slide-in-from-bottom duration-1000" style={{ animationDelay: '300ms' }}>
                        <button
                            onClick={() => setShowPasswordModal(true)}
                            className="group flex items-center justify-center gap-3 px-10 py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-2xl font-bold text-lg transition-all shadow-xl shadow-emerald-600/20 transform hover:-translate-y-1 active:scale-95"
                        >
                            <Lock size={20} />
                            Access Platform
