        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-8 relative overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950">
            ...
            <div className="relative z-10 max-w-6xl w-full">
                ...
                <div className="text-center mb-12 animate-in fade-in slide-in-from-bottom duration-700" style={{ animationDelay: '200ms' }}>
                    ...
                    {/* Login Options */}
                    <div className="mb-12 flex flex-col sm:flex-row justify-center gap-4 px-4 animate-in fade-in slide-in-from-bottom duration-1000" style={{ animationDelay: '300ms' }}>
                        <button
                            onClick={() => setShowPasswordModal(true)}
                            className="group flex items-center justify-center gap-3 px-8 py-4 bg-slate-900/80 border border-slate-700 hover:border-emerald-500/50 text-white rounded-2xl font-bold text-lg transition-all shadow-xl hover:shadow-emerald-500/10 transform hover:-translate-y-1 active:scale-95"
                        >
                        ...
                        <button
                            ...
                            className="group flex items-center justify-center gap-3 px-8 py-4 bg-white hover:bg-slate-100 text-slate-900 rounded-2xl font-bold text-lg transition-all shadow-xl hover:shadow-white/10 transform hover:-translate-y-1 active:scale-95"
                        >
