        ...
        <main className="flex min-h-screen flex-col items-center justify-center p-24 bg-gradient-to-br from-slate-950 to-slate-900">
            ...
            <div className="relative flex place-items-center flex-col gap-8">
                ...
                <div className="flex flex-col gap-4 mt-8">
                    ...
                    >
                        <button className="flex items-center gap-3 px-6 py-3 bg-white text-black rounded-lg hover:bg-gray-100 transition-colors font-medium">
                    ...
                    <div className="text-xs text-slate-600 flex items-center justify-center gap-2">
                        ...
                        <span>Restricted Access: @uhurutradeuk & raul.irus only</span>
                    </div>
                </div>
            </div>
        </main>
